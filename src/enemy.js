...
export class Hippie extends Enemy {
  constructor(health) {
    ...
    this.haikus[9] = ["You think I smell bad", "I think that I smell groovy", "a natural scent"];
  }
}
// this.haikus[] = ["", "", ""];
export class Hipster extends Enemy {
  constructor(health) {
    ...
    this.haikus[9] = ["I don't smoke, I vape", "I have multiple flavors", "in my fanny-pack"];
  }
}
...
export class Hacker extends Enemy {
  constructor(health) {
    super(health);
    this.name = "Hacker";
    this.keywords = ["code", "hacked",  "hacker", "computer", "internet", "javascript", "password", "asynchronously", "logic"];
    this.haikus = [];
    ...
    this.haikus[8] = ["The Internet's down", "What is your wi-fi password", "I AM DESPERATE!"];
    this.haikus[9] = ["Carpal tunnel hurt", "but I press on with my work", "it is my calling"];
  }
}
...
export class Professor extends Enemy {
  constructor(health) {
    super(health);
    this.name = "Professor";
    this.keywords = ["vocabulary", "intimidating", "illuminati", "megalomaniacal", "conceptualization", "unbelievable", "university", "mathematical"];
    this.haikus = [];
    ...
    this.haikus[9] = ["Vociferate an", "Anesthesiologist", "to numb your sick burns"];
  }
}
...
export class Goth extends Enemy {
  constructor(health) {
    ...
    this.haikus[8] = ["NO! I'm not emo.", "I'm goth, there's a difference.", "Though I'm not sure what..."];
    this.haikus[9] = ["Coffins are cozy", "black roses are beautiful", "can't wait for my wake"];
  }
}
